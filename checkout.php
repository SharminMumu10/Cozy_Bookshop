...
$address = mysqli_real_escape_string($conn, 'flat no. '. $_POST['flat'].', '. $_POST['street'].', '. $_POST['city'].',  - '. $_POST['state']);   $placed_on = date('d-M-Y');
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="flat" required placeholder="e.g. flat no.road no.">
         </div>
         <div class="inputBox">
            <span>Address Line 01 :</span>
         ...
         <div class="inputBox">
            ...
            <input type="text" name="state" required placeholder="e.g. mirpur">
         </div>
